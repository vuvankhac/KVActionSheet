...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of KVActionSheet.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/KVActionSheet'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Vu Van Khac' => 'khacvv0451@gmail.com' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/KVActionSheet.git', :tag => s.version.to_s }
